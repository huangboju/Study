//
//  IMContinuousPushViewController.m
//  IMDynamics
//
...
#import "IMContinuousPushViewController.h"

@interface IMContinuousPushViewController ()
...
@implementation IMContinuousPushViewController
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    UIPushBehavior *pushBehavior = [[UIPushBehavior alloc] initWithItems:@[self.box] mode:UIPushBehaviorModeContinuous];
