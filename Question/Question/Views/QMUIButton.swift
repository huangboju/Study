...
//    @IBInspectable
//    public var fillColor: UIColor? // 默认为 FillButtonColorBlue
//    @IBInspectable
//    public var titleTextColor: UIColor? // 默认为 UIColorWhite
//    // 默认为 QMUIFillButtonCornerRadiusAdjustsBounds，也即固定保持按钮高度的一半。
//    var cornerRadius: CGFloat = 0
//    
//    /**
//     *  控制按钮里面的图片是否也要跟随 `titleTextColor` 一起变化，默认为 `NO`
//     */
//     var adjustsImageWithTitleTextColor = false
//    
//    convenience init() {
...
//    }
//
//    init(fillType: QMUIFillButtonColor, frame: CGRect) {
